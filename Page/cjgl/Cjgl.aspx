<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cjgl.aspx.cs" Inherits="Page_cjgl_Cjgl" %>
   ...
   <div id="allContainer" class="menus-normal">
    <dl class="menus-module" style=""> 
     ...
     <dd id="btn1" class="menus-item"  > 
      <a href="javascript:void(0);"> <span class="mi-info logo"></span> <span class="mi-info txt">设备报修</span> <span class="mi-info check txt">进入</span> </a> 
     </dd> 
